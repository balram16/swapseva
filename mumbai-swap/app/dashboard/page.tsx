...
import { ArrowRight, Award, Clock, Handshake, TrendingUp, MessageSquare, Shield, Sparkles } from "lucide-react"
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      <span className="font-medium">Offers:</span> Yoga Classes 🧘‍♀️
                    </p>
                    <p className="text-sm text-muted-foreground">
                      <span className="font-medium">Needs:</span> Web Development 💻
                    </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      <span className="font-medium">Offers:</span> Graphic Design 🎨
                    </p>
                    <p className="text-sm text-muted-foreground">
                      <span className="font-medium">Needs:</span> Guitar Lessons 🎸
                    </p>
                    <div className="flex items-center gap-2 pt-2">
                      <Button size="sm" variant="default">
                        Connect
